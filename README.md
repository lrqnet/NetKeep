...
<p align="center">
  ...
  <a href="https://github.com/lrqnet/NetKeep/releases/tag/v1.0.0"><img src="https://img.shields.io/badge/release-v1.0.0-0f172a" alt="NetKeep v1.0.0"></a>
...
Create a directory, download the Compose file attached to the v1.0.0 release,
and start the stack:

```bash
sudo mkdir -p /opt/netkeep
cd /opt/netkeep
sudo curl -fsSLO https://github.com/lrqnet/NetKeep/releases/download/v1.0.0/compose.yaml
