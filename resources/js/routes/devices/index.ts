...
/**
 * @see \App\Http\Controllers\DeviceController::revokeApproval
...
export const revokeApproval = (
    ...
    url: revokeApproval.url(args, options),
    method: 'post',
});

revokeApproval.definition = {
    methods: ['post'],
...
const revokeApprovalForm = (
    ...
    action: revokeApproval.url(args, options),
    method: 'post',
});
...
revokeApproval.form = revokeApprovalForm;
...
const devices = {
    ...
    forceCollect: Object.assign(forceCollect, forceCollect),
    approve: Object.assign(approve, approve),
    revokeApproval: Object.assign(revokeApproval, revokeApproval),
